        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-12 col-xl-10 offset-xl-1">
                    <h1 class="pa-h1-v2 pa-bright fadeInDelay00Duration10">S' <strong>Inscrire</strong></h1>
                ...
                <div class="col-12 col-md-6 col-xl-5 pa-contact-form d-flex justify-content-end">
                    <div class="pa-glass pa-right">
                        ...
                        <div class="sf-wrapper">
                            <form id="contact-form-1" method="GET" action="{{ route('utilisateur.signup') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Sexe</label>
                                    <div>
                                        <select style="width: 100%;height: 40px;background-color:#8E97A121;color:gray" type="text" name="sexe" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="motdepasseconfirm" value="">
                                </div>
                                ...
                                <div>
                                    <label>Vous avez déjà un compte ? <a style="color:#9300F5" onclick="login()">Se connecter.</a></label>
                                </div>

                                <div class="form-submit">
                                    <button type="submit" class="pa-hvr-sweep-to-right">S' Inscrire</button>
                                </div>
